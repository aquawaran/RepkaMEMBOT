...
class RouletteGame:
    ...
    def parse_bet_value(self, bet_value: str) -> Tuple[str, float]:
        ...
        # Цвета
        if bet_value_lower in ["красный", "черный"]:
            return "цвет", 2.0
    ...
    async def show_help(self, message: Message):
        ...
        help_text += "📋 КОМАНДЫ:\n"
        help_text += "• Рулетка [ставка] [ставки...] - сделать ставки\n"
        ...
        help_text += "• Цвет: Рулетка 1000 красный/черный (2x), зеленый (35x)\n"
        ...
        help_text += "• Рулетка 1000 1 3 5 12-16 17-19 27\n"
        help_text += "• Рулетка 500 красный черный odd 1-18\n\n"
